  ...
  return (
    <>
      <div className="fixed bottom-6 left-6 z-50 hidden md:block">
        <a
          href={`https://wa.me/${SITE.phone.whatsapp.replace(/[^0-9]/g, "")}`}
          target="_blank"
          rel="noopener noreferrer"
          className="flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg shadow-[#25D366]/30 transition-all duration-200 hover:scale-110 hover:shadow-xl"
          aria-label="WhatsApp"
        >
          <WhatsAppIcon />
        </a>
