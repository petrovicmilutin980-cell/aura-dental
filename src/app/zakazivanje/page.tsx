...
export const metadata: Metadata = {
  ...
  description: "Rezervišite vaš termin u AURA Dental Clinic u nekoliko jednostavnih koraka.",
};
      ...
      <section className="relative bg-midnight pt-32 pb-16 md:pt-40 md:pb-24">
        ...
        <div className="relative mx-auto max-w-7xl px-6 text-center">
          ...
          <p className="mt-4 text-lg text-alabaster/60 max-w-2xl mx-auto">
            Rezervišite vaš termin u nekoliko jednostavnih koraka
          </p>
        </div>
      </section>
            ...
            <div className="space-y-8">
              <div className="rounded-2xl bg-white p-6 shadow-sm">
                ...
                <div className="mt-4 space-y-4 text-sm">
                  <div>
                    <p className="font-medium text-midnight">Telefon</p>
                  ...
                  <div>
                    <p className="font-medium text-midnight">Hitni slučajevi</p>
